...
-- Minimal, idempotent repair for enterprise acceptance navigation.
-- Source of truth: 意见反馈20260602.md.
-- Use this when historical menu scripts are unsafe to source because of encoding drift.
...
(900170, '维度列表查询', 900110, 10, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:dimension:list', '#', 103, 1, sysdate(), '维度列表查询权限'),
(900171, '维度详情查询', 900110, 11, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:dimension:query', '#', 103, 1, sysdate(), '维度详情查询权限'),
(900172, '维度新增', 900110, 12, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:dimension:add', '#', 103, 1, sysdate(), '维度新增权限'),
(900173, '维度修改', 900110, 13, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:dimension:edit', '#', 103, 1, sysdate(), '维度修改权限'),
(900174, '维度删除', 900110, 14, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:dimension:remove', '#', 103, 1, sysdate(), '维度删除权限'),

(900180, '排放源列表查询', 900130, 10, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:emissionSource:list', '#', 103, 1, sysdate(), '排放源列表查询权限'),
(900181, '排放源详情查询', 900130, 11, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:emissionSource:query', '#', 103, 1, sysdate(), '排放源详情查询权限'),
(900182, '排放源新增', 900130, 12, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:emissionSource:add', '#', 103, 1, sysdate(), '排放源新增权限'),
(900183, '排放源修改', 900130, 13, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:emissionSource:edit', '#', 103, 1, sysdate(), '排放源修改权限'),
(900184, '排放源删除', 900130, 14, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:emissionSource:remove', '#', 103, 1, sysdate(), '排放源删除权限'),
(900185, '活动数据列表查询', 900130, 15, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:activityData:list', '#', 103, 1, sysdate(), '活动数据列表查询权限'),
(900186, '活动数据详情查询', 900130, 16, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:activityData:query', '#', 103, 1, sysdate(), '活动数据详情查询权限'),
(900187, '活动数据校验', 900130, 17, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:activityImportValidation:validate', '#', 103, 1, sysdate(), '活动数据校验权限'),
(900188, '活动数据保存', 900130, 18, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:activity:save', '#', 103, 1, sysdate(), '活动数据保存权限'),
(900189, '活动数据导入', 900130, 19, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:activityImport:import', '#', 103, 1, sysdate(), '活动数据导入权限'),

(900190, '因子确认列表查询', 900120, 10, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorConfirmation:list', '#', 103, 1, sysdate(), '因子确认列表查询权限'),
(900191, '因子确认详情查询', 900120, 11, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorConfirmation:query', '#', 103, 1, sysdate(), '因子确认详情查询权限'),
(900192, '因子确认新增', 900120, 12, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorConfirmation:add', '#', 103, 1, sysdate(), '因子确认新增权限'),
(900193, '因子确认修改', 900120, 13, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorConfirmation:edit', '#', 103, 1, sysdate(), '因子确认修改权限'),
(900194, '因子确认删除', 900120, 14, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorConfirmation:remove', '#', 103, 1, sysdate(), '因子确认删除权限'),
(900195, '绿电绿证列表查询', 900140, 10, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:greenPowerCertificate:list', '#', 103, 1, sysdate(), '绿电绿证列表查询权限'),
(900196, '绿电绿证详情查询', 900140, 11, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:greenPowerCertificate:query', '#', 103, 1, sysdate(), '绿电绿证详情查询权限'),
(900197, '绿电绿证新增', 900140, 12, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:greenPowerCertificate:add', '#', 103, 1, sysdate(), '绿电绿证新增权限'),
(900198, '绿电绿证修改', 900140, 13, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:greenPowerCertificate:edit', '#', 103, 1, sysdate(), '绿电绿证修改权限'),
(900199, '绿电绿证删除', 900140, 14, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:greenPowerCertificate:remove', '#', 103, 1, sysdate(), '绿电绿证删除权限'),
(900200, '强度指标列表查询', 900150, 10, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:intensityMetric:list', '#', 103, 1, sysdate(), '强度指标列表查询权限'),
(900201, '强度指标详情查询', 900150, 11, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:intensityMetric:query', '#', 103, 1, sysdate(), '强度指标详情查询权限'),
(900202, '强度指标新增', 900150, 12, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:intensityMetric:add', '#', 103, 1, sysdate(), '强度指标新增权限'),
(900203, '强度指标修改', 900150, 13, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:intensityMetric:edit', '#', 103, 1, sysdate(), '强度指标修改权限'),
(900204, '强度指标删除', 900150, 14, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:intensityMetric:remove', '#', 103, 1, sysdate(), '强度指标删除权限'),
...
(900211, '厂商因子同步', 900120, 15, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorSync:run', '#', 103, 1, sysdate(), '厂商因子同步权限'),
(900212, '厂商模板同步', 900160, 16, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:reportTemplateSync:run', '#', 103, 1, sysdate(), '厂商模板同步权限'),
(900213, '因子缓存列表查询', 900120, 16, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorCacheRecord:list', '#', 103, 1, sysdate(), '因子缓存列表查询权限'),
(900214, '因子缓存详情查询', 900120, 17, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:factorCacheRecord:query', '#', 103, 1, sysdate(), '因子缓存详情查询权限'),
(900215, '扩展字段元数据查询', 900130, 20, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:extensionField:list', '#', 103, 1, sysdate(), '扩展字段元数据查询权限'),
(900216, '扩展字段值列表查询', 900130, 21, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:extensionFieldValue:list', '#', 103, 1, sysdate(), '扩展字段值列表权限'),
(900217, '扩展字段值新增', 900130, 22, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:extensionFieldValue:add', '#', 103, 1, sysdate(), '扩展字段值新增权限'),
(900218, '扩展字段值修改', 900130, 23, '#', '', '', 1, 0, 'F', '1', '0', 'enterprise:extensionFieldValue:edit', '#', 103, 1, sysdate(), '扩展字段值修改权限');
