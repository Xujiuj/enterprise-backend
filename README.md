...
This project is the enterprise-side local backend for the carbon data management platform.

- Delivery boundary: independent Spring Boot/Maven backend under `enterprise-backend`.
...
- Business data boundary: enterprise core data stays in the enterprise local database and must not be synchronized into the vendor backend.
